...
export const videoUploader = asyncHandler(async function (req, res) {
  ...
  return res
    .status(200)
    .json(new ApiResponse("200", videoUploadResponse, "Uploaded Sucessfully"));
});
...
export const deleteVideo = asyncHandler(async function (req, res) {
  ...
  try {
    ...
    const resofthumbNail = await minioClient.removeObject(
      "backend",
      videoFileID,
    );
  } catch (error) {
...
export const editVideo = asyncHandler(async function (req, res) {
  ...
  return res.status(200).json(new ApiResponse("200", "Edit Successfully Done"));
});
...
export const getFeedVideos = asyncHandler(async function (req, res) {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, videos, "Video fecthed Successfully"));
});
...
export const addViews = asyncHandler(async function (req, res) {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, addedViews, "Views Added Successfully"));
});
...
export const findVideoByName = asyncHandler(async function (req, res) {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, Response, "Video fecthed Succesfully"));
});
